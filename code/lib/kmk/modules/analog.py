...
class AnalogKey(Module):
    ...
    def during_bootup(self, keyboard):
        ...
        self.lastVal = [self.pin1.value,self.pin2.value,self.pin3.value,self.pin4.value]
        self.keyPre1 = 0
        self.keypre2 = 0
        self.keyPre3 = 0
        self.keyPre4 = 0
    ...
    def before_matrix_scan(self, keyboard):
        ...
        if self.keypType[layer_id] == 0: #Threshold
            ...
            if (self.pin1.value < self.threshold[0] and self.state[0] == 1 and not self.reverse) or (self.pin1.value > self.threshold[0] and self.state[0] == 1 and self.reverse):
                self.keyPre1 = self.map[layer_id][0]
                keyboard.add_key(self.keyPre1)
                self.state[0]=0
                self.state[1]=1
                ...
                keyboard.remove_key(self.keyPre1)
                self.state[1]=0
                self.state[0]=1
            ...
            if (self.pin2.value < self.threshold[0] and self.state[2] == 1 and not self.reverse) or (self.pin2.value > self.threshold[0] and self.state[2] == 1 and self.reverse):
                self.keyPre2 = self.map[layer_id][1]
                keyboard.add_key(self.keyPre2)
                self.state[2]=0
                self.state[3]=1
                ...
                keyboard.remove_key(self.keyPre2)
                self.state[3]=0
                self.state[2]=1
            ...
            if (self.pin3.value < self.threshold[0] and self.state[4] == 1 and not self.reverse) or (self.pin3.value > self.threshold[0] and self.state[4] == 1 and self.reverse):
                self.keyPre3 = self.map[layer_id][2]
                keyboard.add_key(self.keyPre3)
                self.state[4]=0
                self.state[5]=1
                ...
                keyboard.remove_key(self.keyPre3)
                self.state[5]=0
                self.state[4]=1
            ...
            if (self.pin4.value < self.threshold[0] and self.state[6] == 1 and not self.reverse) or (self.pin4.value > self.threshold[0] and self.state[6] == 1 and self.reverse):
                self.keyPre4 = self.map[layer_id][3]
                keyboard.add_key(self.keyPre4)
                self.state[6]=0
                self.state[7]=1
                ...
                keyboard.remove_key(self.keyPre4)
                self.state[7]=0
                self.state[6]=1
       #-------------------------------------------------------------------------------------------------------------------------------------------------  
        #rapid trigger mode
